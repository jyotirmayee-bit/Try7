...
Pharmacy Dashboard
------------------
UNIT DASHBOARD for the Pharmacy incharge.
...
st.set_page_config(
    page_title="Srikara Hospitals | Pharmacy",
    page_icon="💊",
    layout="wide",
)
...
st.title("💊 Pharmacy — Unit Dashboard")
st.caption("Owner: Pharmacy")

# ---------------------------------------------------------------------
# Load data and keep only this department's rows
# ---------------------------------------------------------------------
master_df = load_master_data()
dept_df = filter_by_department(master_df, "Pharmacy")
...
# =======================================================================
with tab_detail:
    search = st.text_input("Search KPIs in Pharmacy", placeholder="e.g. mortality, occupancy...")
