...
-----------------------
UNIT DASHBOARD for the Medical Staff incharge.
...
st.set_page_config(
    page_title="Srikara Hospitals | Medical Staff",
    page_icon="👩‍⚕️",
    layout="wide",
)
...
st.title("👩‍⚕️ Medical Staff — Unit Dashboard")
st.caption("Owner: MS")
...
dept_df = filter_by_department(master_df, "Medical Staff")
...
# =======================================================================
with tab_detail:
    search = st.text_input("Search KPIs in Medical Staff", placeholder="e.g. mortality, occupancy...")
