...
-----------------------
UNIT DASHBOARD for the OT Operations incharge.
...
st.set_page_config(
    page_title="Srikara Hospitals | OT Operations",
    page_icon="🔪",
    layout="wide",
)
...
st.title("🔪 OT Operations — Unit Dashboard")
st.caption("Owner: OT Incharge")

# ---------------------------------------------------------------------
# Load data and keep only this department's rows
# ---------------------------------------------------------------------
master_df = load_master_data()
dept_df = filter_by_department(master_df, "OT Operations")
...
with tab_detail:
    ...
    search = st.text_input("Search KPIs in OT Operations", placeholder="e.g. mortality, occupancy...")
