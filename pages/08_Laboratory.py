...
--------------------
UNIT DASHBOARD for the Laboratory incharge.
...
st.set_page_config(
    page_title="Srikara Hospitals | Laboratory",
    page_icon="🧪",
    layout="wide",
)
...
st.title("🧪 Laboratory — Unit Dashboard")
st.caption("Owner: Lab")

# ---------------------------------------------------------------------
# Load data and keep only this department's rows
# ---------------------------------------------------------------------
master_df = load_master_data()
dept_df = filter_by_department(master_df, "Laboratory")
...
# =======================================================================
with tab_detail:
    search = st.text_input("Search KPIs in Laboratory", placeholder="e.g. mortality, occupancy...")
