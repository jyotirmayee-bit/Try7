"""
ICU Operations Dashboard
------------------------
UNIT DASHBOARD for the ICU Operations incharge.
...
st.set_page_config(
    page_title="Srikara Hospitals | ICU Operations",
    page_icon="❤️‍🩹",
    layout="wide",
)
...
st.title("❤️‍🩹 ICU Operations — Unit Dashboard")
st.caption("Owner: ICU Incharge")

# ---------------------------------------------------------------------
# Load data and keep only this department's rows
# ---------------------------------------------------------------------
master_df = load_master_data()
dept_df = filter_by_department(master_df, "ICU Operations")
...
# =======================================================================
with tab_detail:
    search = st.text_input("Search KPIs in ICU Operations", placeholder="e.g. mortality, occupancy...")
