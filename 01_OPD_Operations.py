...
------------------------
UNIT DASHBOARD for the OPD Operations incharge.
...
st.set_page_config(
    page_title="Srikara Hospitals | OPD Operations",
    page_icon="🩺",
    layout="wide",
)
...
st.title("🩺 OPD Operations — Unit Dashboard")
st.caption("Owner: OP Incharge")

# ---------------------------------------------------------------------
# Load data and keep only this department's rows
# ---------------------------------------------------------------------
master_df = load_master_data()
dept_df = filter_by_department(master_df, "OPD Operations")
...
with tab_detail:
    ...
    search = st.text_input("Search KPIs in OPD Operations", placeholder="e.g. mortality, occupancy...")
